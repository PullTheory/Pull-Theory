...
type Listing = { id: number; offeredCard: string; listingType?: ListingType; salePriceCents?: number | null; status?: string; user_id?: string | null };
  ...
  async function saveListing(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await fetch("/api/trades", {
        ...
        body: JSON.stringify({ action: "update_listing", listingId: id, listingType, salePriceCents }),
      });
      const result = await response.json();
