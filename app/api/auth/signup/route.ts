...
export async function POST(request: NextRequest) {
  try {
    ...
    const redirectTo = "https://pulltheorytrade.com/login?confirmed=1&returnTo=%2Fwelcome-rip";
    ...
    const text = `Welcome to Pull Theory.\n\nConfirm your email address, then open your free Welcome Rip:\n${actionLink}\n\nOne rip per eligible new account while inventory lasts.\n\nPull Theory\nhttps://pulltheorytrade.com`;
    const html = `<!doctype html><html><body style="margin:0;background:#f5f5f7;font-family:Arial,Helvetica,sans-serif;color:#18181b"><table role="presentation" width="100%"><tr><td align="center" style="padding:32px 16px"><table role="presentation" width="100%" style="max-width:560px;background:#fff;border:1px solid #e4e4e7;border-radius:16px"><tr><td style="padding:32px"><p style="font-weight:700;color:#6d28d9">PULL THEORY</p><h1>Your Welcome Rip is waiting</h1><p>Confirm your email to activate your collector account. After confirmation, you’ll see a confirmation message, then sign in and open your one-time Welcome Rip.</p><a href="${safeLink}" style="display:inline-block;padding:14px 22px;background:#6d28d9;border-radius:10px;color:#fff;text-decoration:none;font-weight:700">Confirm email & continue</a><p style="margin-top:20px;font-size:13px;color:#71717a">One rip per eligible new account while inventory lasts. No purchase necessary.</p><p style="margin-top:18px;font-size:13px;color:#71717a">If you didn't create an account, you can safely ignore this email.</p></td></tr></table></td></tr></table></body></html>`;
